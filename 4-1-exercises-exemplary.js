...
// Create an object containing methods to be inherited by the instances
// of the factory function 
const friendListMethods = { 
  addFriend(name) {
...
function makeFriendList(){
  // Create a new friendList object that inherits methods from friendListMethods 
  let friendList = Object.create(friendListMethods);
  // Add a _friends property and return
  friendList._friends = [];
  return friendList;
}
